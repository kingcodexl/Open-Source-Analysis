...
- (void)setUpNavigationItem
{
    ...
    //注意绑定UISegmentedControl点击按钮的方式和一般按钮的方式不一样。这里用UIControlEventValueChanged
...
- (void)setUpUI
{
    ...
    /*
    self.rmedView.rowHeight = 20;
    self.rmedView.sectionHeaderHeight = 60;
     */
...
#pragma mark - titleViewAction。用于处理segment点击不同的item
